...
<body>
	...
	$question = htmlentities(mysqli_real_escape_string($db , $_POST['question']));
	$iscategory = htmlentities(mysqli_real_escape_string($db , $_POST['iscategory']));
	$isstage = htmlentities(mysqli_real_escape_string($db , $_POST['isstage']));
	$istype = htmlentities(mysqli_real_escape_string($db , $_POST['istype']));
	$choice1 = htmlentities(mysqli_real_escape_string($db , $_POST['choice1']));
	$choice2 = htmlentities(mysqli_real_escape_string($db , $_POST['choice2']));
	$choice3 = htmlentities(mysqli_real_escape_string($db , $_POST['choice3']));
	$choice4 = htmlentities(mysqli_real_escape_string($db , $_POST['choice4']));
	$corrects = mysqli_real_escape_string($db , $_POST['answer']);


    $checkqsn = "SELECT * FROM isquestions WHERE question_name = '".$_POST['question']."'";
	$runcheck = mysqli_query($db , $checkqsn) or die(mysqli_error($db));
	...
	$query = "INSERT INTO isquestions(question_name,answer1,answer2,answer3,answer4,answer,category_id,stagesid, 	qtypeid) 
	VALUES 
	('$question','$choice1','$choice2','$choice3','$choice4','$corrects','$iscategory','$isstage','$istype') " ;
...
?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="wrong_answer1" name="choice1" Required>
            </div>
            <div class="form-group">
                <label for="wrong_answer2">Answers 2</label>
                <input type="text" class="form-control" id="wrong_answer2" name="choice2" Required>
            </div>
            <div class="form-group">
                <label for="wrong_answer3">Answers 3</label>
                <input type="text" class="form-control" id="wrong_answer3" name="choice3" Required>
            </div>
             <div class="form-group">
                <label for="wrong_answer3">Answers 4</label>
                <input type="text" class="form-control" id="wrong_answer4" name="choice4" Required>
            </div>
            <div class="form-group">
